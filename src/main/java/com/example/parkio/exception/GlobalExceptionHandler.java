...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ParkioException.class)
    public ResponseEntity<ApiResponse<Void>> handleParkioException(ParkioException ex) {
    ...
    public ResponseEntity<ApiResponse<Map<String, String>>> handleValidationException(
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new com.example.parkio.dto.response.ApiResponse<>(
